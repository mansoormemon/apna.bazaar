...
public class ListItemAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView name = rowView.findViewById(R.id.CRT_ITMS_TV_name);
        name.setText(items[position].getName());
        TextView price = rowView.findViewById(R.id.CRT_ITMS_TV_price);
        price.setText(String.valueOf("Rs. " + items[position].getPrice()));
        TextView quantity = rowView.findViewById(R.id.CRT_ITMS_TV_quantity);
        quantity.setText(String.valueOf(items[position].getQuantity()));
        TextView category = rowView.findViewById(R.id.CRT_ITMS_TV_category);
        category.setText(items[position].getCategory());
        TextView unit = rowView.findViewById(R.id.CRT_ITMS_TV_unit);
